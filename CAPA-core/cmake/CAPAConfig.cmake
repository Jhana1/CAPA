...
ELSE()
    ...
    ENDIF()
    SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_LINKER_FLAGS} -fno-rtti -Wno-c++14-extensions -fPIC ${CMAKE_CXX_FLAGS}")
ENDIF()
...
IF(CAPA_BUILD_TYPE STREQUAL "Release")
...
ELSE()
    ...
    SET(CMAKE_SHARED_LINKER_FLAGS "-g -ggdb ${CMAKE_SHARED_LINKER_FLAGS}")
ENDIF()

SET(EXECUTABLE_OUTPUT_PATH ${PROJECT_BINARY_DIR}/bin)

SET(CAPA_VERSION_RELEASE "0.10.2")
